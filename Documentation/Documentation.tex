...
\fig[\textwidth]{includes/PathPlanner1.png}{Engine Structure: Diagram showing the structure.}{fig:EngineStructure}
...
When a mousepress is registered window coordinates are translated into \textit{OpenGL} world space coordinates and an event for pathfinding and movement of the player is triggered.
