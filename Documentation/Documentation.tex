...
\fig[\textwidth]{includes/dota2screen.jpg}{Screenshot from \textit{DOTA2}, showcasing the idea we wanted to achieve.}{fig:DRdota2screen}
...
Interesting stuff regarding how Resources in general are being handled.
